...
class GbBlogParse:
    ...
    def __init__(self, start_url, database: Database, delay=2.0):
    ...
    def parse_post(self, response: requests.Response):
        ...
        data = {
            ...
            "comments_data": self._get_post_comments(soup.find("comments").attrs.get("commentable-id")),
        }
        self._save(data)
...
if __name__ == '__main__':
    ...
    orm_database = Database("sqlite:///gb_blog_parse.sqlite")
